  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        useMaterial3: true,
        // Define a gradient primary color for buttons/accents
      ...
      routes: {
        ...
        '/generating': (context) => const GeneratingTripScreen(),
        '/ready': (context) => const TripReadyScreen(),
...
// --- Theme Extension for Gradient Colors ---
...
class GradientButton extends StatelessWidget {
  final String text;
  final IconData? icon;
  final VoidCallback? onPressed; // 👈 FIX: Made nullable
  final double height;
  ...
  const GradientButton({
    ...
    required this.text,
    this.icon,
    this.onPressed, // 👈 FIX: No longer required
    this.height = 56.0,
  });
  ...
  Widget build(BuildContext context) {
    ...
    // Use opacity to visually disable the button when onPressed is null
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: onPressed, // Handled correctly (null = disabled)
          borderRadius: BorderRadius.circular(30),
          child: Opacity( // Apply opacity to the content
            opacity: opacity,
            child: Center(
              child: Row(
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Icon - A simple plane icon is used here for simplicity
              CircleAvatar(
                radius: 50,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        automaticallyImplyLeading: false, // For chat flow, usually no back button
      ),
      body: Column(
        children: [
  ...
  Widget _buildInterestsSelection() {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        // This is the fixed line: onPressed is now correctly VoidCallback?
        GradientButton(
...
class _GeneratingTripScreenState extends State<GeneratingTripScreen> {
  ...
  void _startGenerationProcess() async {
    ...
    // Navigate to TripReadyScreen after all steps are complete
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Placeholder for the spinning globe/icon animation
              Icon(
...
class TripReadyScreen extends StatelessWidget {
  const TripReadyScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final gradientColors = Theme.of(context).extension<GradientColors>()!;
    const String destination = 'Pune';
    const int days = 3;
    const List<String> interests = ['Adventure', 'Nature'];
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Your perfect 3-day adventure awaits',
                        style: TextStyle(fontSize: 16, color: Colors.grey),
                      ),
                      const SizedBox(height: 30),
                      Container(
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    '${destination.toUpperCase()} Adventure',
                                    style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 24,
                                      fontWeight: FontWeight.bold,
                            ...
                            _buildCheckRow('Weather checked', Colors.green),
                            _buildCheckRow('Attractions optimized', Colors.green),
                            _buildCheckRow('Itinerary personalized', Colors.green),
                          ],
                        ),
                      ),
                    ],
...
class ItineraryScreen extends StatelessWidget {
  ...
  // Dummy Itinerary Data - Note: Attractions are from Kyoto, Japan, despite the "pune" label in the images,
  // following the content of the image's itinerary section.
  final List<Map<String, dynamic>> dummyItinerary = const [
    {
      'day': 1,
      'attractions': [
        {
          ...
          'description': 'Historic Buddhist temple with stunning views of Kyoto',
          'weather': 'Sunny, 72°F',
          'duration': '2 hours',
          'image': 'temple_placeholder',
        },
        {
          'name': 'Nishiki Market',
      ...
      'attractions': [
        {
          ...
          'description': 'Walk through towering bamboo forest paths',
          'weather': 'Partly Cloudy, 70°F',
          'duration': '2 hours',
          'image': 'bamboo_placeholder',
        },
        {
      ...
      body: Stack(
        children: [
          CustomScrollView(
            slivers: [
              SliverAppBar(
                expandedHeight: 200.0, // Increased height for better initial look
                collapsedHeight: 120.0, // Set a specific collapsed height
                pinned: true,
                flexibleSpace: FlexibleSpaceBar(
                  titlePadding: const EdgeInsets.only(bottom: 16, left: 16),
                  // The Column inside FlexibleSpaceBar title was the overflow culprit
                  title: Column( 
                    ...
                    children: [
                      ...
                      Text(
                        '$days-day ${interests.join(', ')} adventure',
                        style: const TextStyle(color: Colors.grey, fontSize: 14),
                      ),
                      const SizedBox(height: 8),
                      // FIX: Wrapped the button row in FittedBox and reduced button size/padding
                      FittedBox( 
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, dayIndex) {
                    final dayData = dummyItinerary[dayIndex];
                    return _buildDaySection(context, dayData);
                  },
                  childCount: dummyItinerary.length,
                ),
              ),
          ...
          Align(
            ...
            child: Padding(
              ...
              child: GradientButton(
                ...
                onPressed: () {
                  // In a real app, this would navigate to a final summary screen
                },
              ),
            ),
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ...dayData['attractions'].asMap().entries.map((entry) {
                ...
                children: [
                  Column(
                    children: [
                      ...
                      // Timeline line
                      if (index < dayData['attractions'].length - 1)
                        Expanded(
                          child: Container(
                            width: 2,
  ...
  Widget _buildAttractionCard(BuildContext context, Map<String, dynamic> attraction) {
    // Placeholder image asset replacement
    // In a real app, you'd use a network image here
    final imagePlaceholder = Container(
      ...
      child: Center(child: Text(attraction['image']!)),
    );
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('${attraction['duration']}'),
                    ),
                  ],
                ),
              ],
