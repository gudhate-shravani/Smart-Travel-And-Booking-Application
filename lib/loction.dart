  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Smart navigation & place discovery',
...
/*  Widget _buildSearchBar() {
    return Card(
      ...
      child: TextField(
        ...
        ), // <-- FIX: Close InputDecoration here
      ),
    );
  }*/
  Widget _buildSearchBar() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.location_pin, color: Colors.blue, size: 32),
                    Text('Interactive Map View', style: TextStyle(fontWeight: FontWeight.bold)),
                    Text('Current Location: Connaught Place', style: TextStyle(color: Colors.black54, fontSize: 12)),
                  ],
                ),
              ),
            ),
            ...
            Row(
              children: [
                Expanded(child: OutlinedButton.icon(onPressed: (){}, icon: const Icon(Icons.center_focus_strong_outlined, size: 18), label: const Text('Center Map'))),
                const SizedBox(width: 16),
                Expanded(child: ElevatedButton.icon(onPressed: (){}, icon: const Icon(Icons.my_location_rounded, size: 18, color: Colors.white), label: const Text('My Location', style: TextStyle(color: Colors.white)), style: ElevatedButton.styleFrom(backgroundColor: Colors.black87))),
              ],
            )
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 12,
              children: [
                _quickActionItem(Icons.near_me_rounded, 'Navigate\nHome', Colors.blue),
                _quickActionItem(Icons.local_parking_rounded, 'Find\nParking', Colors.green),
                _quickActionItem(Icons.traffic_rounded, 'Traffic\nUpdates', Colors.orange),
                _quickActionItem(Icons.call_rounded, 'Emergency', Colors.red),
              ],
            ),
          ],
        ),
    ...
    return SizedBox(
      ...
      child: ScrollConfiguration(
        ...
        child: ListView.builder(
          ...
          shrinkWrap: true,
          physics: const AlwaysScrollableScrollPhysics(), // Ensures horizontal scroll always works
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Connaught Place, New Delhi', style: TextStyle(color: Colors.black54)),
                Text('Accuracy: ±5 meters', style: TextStyle(color: Colors.black54, fontSize: 12)),
              ],
            ),
          ),
          OutlinedButton.icon(onPressed: (){}, icon: const Icon(Icons.share_outlined, size: 16), label: const Text('Share')),
        ],
      ),
    );
  }
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: const Text('6 found', style: TextStyle(color: Colors.white, fontSize: 12)),
            ),
          ],
        ),
        const SizedBox(height: 12),
        _placeCard('AIIMS Hospital', 'Ansari Nagar, New Delhi', '2.3 km', '8 mins', '4.2', Icons.local_hospital_rounded),
        const SizedBox(height: 12),
        _placeCard('HP Petrol Pump', 'Ring Road, New Delhi', '1.1 km', '4 mins', '4', Icons.local_gas_station_rounded),
        const SizedBox(height: 12),
        _placeCard('McDonald\'s', 'Connaught Place', '3.2 km', '12 mins', '4.3', Icons.restaurant_menu),
      ],
    );
  }
 Widget _placeCard(String name, String address, String dist, String time, String rating, IconData icon) {
    return Card(
      child: Padding(
  ...
  Widget _buildLiveTrafficUpdates() {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Live Traffic Updates', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            const SizedBox(height: 12),
            _trafficUpdateItem(Icons.warning_amber_rounded, 'Heavy Traffic', 'Ring Road - Congestion due to ongoing construction. +15 mins delay', Colors.red),
            const Divider(),
            _trafficUpdateItem(Icons.check_circle_outline_rounded, 'Clear Route', 'Delhi-Gurgaon Expressway - Normal traffic flow. On time', Colors.green),
            const Divider(),
            _trafficUpdateItem(Icons.info_outline_rounded, 'Route Alert', 'Metro construction on MG Road - Alternative routes available', Colors.blue),
          ],
        ),
      ),
    );
  }
  Widget _trafficUpdateItem(IconData icon, String title, String subtitle, Color color) {
    return Padding(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(decoration: InputDecoration(labelText: 'Start Location', prefixIcon: Icon(Icons.my_location))),
              SizedBox(height: 16),
              TextField(decoration: InputDecoration(labelText: 'Destination', prefixIcon: Icon(Icons.location_on))),
            ],
          ),
          actions: [
            TextButton(onPressed: () => Navigator.of(context).pop(), child: Text('Cancel')),
            ElevatedButton(onPressed: () => Navigator.of(context).pop(), child: Text('Find Routes')),
          ],
