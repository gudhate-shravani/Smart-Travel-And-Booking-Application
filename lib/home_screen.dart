...
class _HomeScreenState extends State<HomeScreen> {
  // --- WIDGET BUILDERS for a cleaner build method ---
      ...
      children: [
        StaggeredGridTile.count(
          ...
          child: _buildOverviewCard(
            context,
            // --- FIXED ICON HERE ---
            icon: Icons.currency_rupee, // Using Material Icon
            label: 'This Month',
            value: '₹45,680',
            subValue: '+12%',
 ...
 Widget _buildOverviewCard(BuildContext context,
  ...
  return Container(
    height: 120, // ✅ Fixed uniform height for all
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            // --- FIXED ICON HERE ---
            _buildDetailRow(Icons.currency_rupee, price), // Using Material Icon
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor:
                          Colors.transparent, // Handled by gradient
        ...
        child: Column(
          ...
          children: [
            ...
            _buildRequestCard(
              ...
              packageName: 'Pink City Heritage',
              date: 'Oct 15, 2025',
              time: '10:00 AM',
            ...
            _buildRequestCard(
              ...
              packageName: 'Backwaters of Kerala',
              date: 'Oct 22, 2025',
              time: '11:00 AM',
