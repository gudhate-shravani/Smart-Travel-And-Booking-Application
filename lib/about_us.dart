...
// --- Data Model for Team Members (Kept but not used in the ListView) ---
class TeamMember {
  final String name;
  final String role;
...
// --- Sample Data (Kept but not used in the ListView) ---
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.deepPurple.shade50, // Light purple background for contrast
...
// --- Team Member Card Widget (Kept but not used in the ListView) ---
class TeamCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ... (UI remains here)
    return Container(); // Returning an empty container since we won't display team members
  }
}

// --- Mentor/Thanks Card Widget (Uses Asset Image) ---
class MentorCard extends StatelessWidget {
  final String name;
  final String description;
  // Use a final static variable for the image path
...
// --- The About Us Screen (TeamScreen) ---

class AboutUsScreen extends StatelessWidget {
  const AboutUsScreen({super.key});

  // Items to display: ProjectInfo (1) + Rahul Sir (1) + Shashi Sir (1) + Footer (1) = 4 items
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          if (index == 0) {
            ...
            // Index 2: Shashi Bagal Sir Mentor Card (the gradient one)
