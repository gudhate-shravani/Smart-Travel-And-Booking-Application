...
// You would typically include the GeminiService and API key here 
// if you were connecting this budget estimator to a real AI endpoint.
// For this UI-only version, we keep it simple.
...
// ==============================================================================
// 3. BUDGET START SCREEN (Initial Gradient Landing Page)
// ==============================================================================
...
// ==============================================================================
// 4. BUDGET CHAT SCREEN (Handles all inputs, loading, and results)
// ==============================================================================
...
class _BudgetChatScreenState extends State<BudgetChatScreen> {
  ...
  // 0: Destination, 1: Duration, 2: Style, 3: Show Button, 4: Loading, 5: Results
  int currentStep = 0; 
  bool _isLoading = false;
  bool _showBreakdown = false; // State for the animated breakdown

  final List<String> availableStyles = ['Economy', 'Mid-Range', 'Luxury'];

  // Placeholder data for the result to match the video
      ...
      child: Column(
        children: [
          ...
          AnimatedContainer(
            ...
            height: _showBreakdown ? 300 : 0, // Max height estimation
            child: SingleChildScrollView(
              physics: _showBreakdown ? null : const NeverScrollableScrollPhysics(), // Disable scrolling when collapsed
                    ...
                    : currentStep == 2
                        ...
                        : currentStep == 3
                            ...
                            : currentStep == 4
                                ...
                                : currentStep == 5 
                                  ? GradientButton(
                                      text: 'Start Planning with Budget',
                                      icon: Icons.check_circle,
                                      onPressed: () {
                                        // Simple navigation back to the start screen
