...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Guide> guides = [
     Guide(
      ...
      rate: '\$85',
      experience: 8,
      about: 'Passionate mountain guide with extensive experience in Rocky Mountain National Park. I love sharing the beauty of nature and helping people create unforgettable memories.',
      imageUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=500&q=80',
      specialties: ['Mountain Hiking', 'Rock Climbing', 'Wildlife Tours', 'Photography'],
     ...
     Guide(
      ...
      rate: '\$75',
      experience: 6,
      about: 'Local SF native who knows all the hidden gems and best spots in the city. Specializing in cultural experiences and foodie adventures.',
      imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&q=80',
      specialties: ['City Tours', 'Food & Culture', 'Historical Sites'],
      languages: ['English'],
    ),
    Guide(
      ...
      rate: '\$120',
      experience: 12,
      about: 'Expert safari guide with deep knowledge of African wildlife and ecosystems. Committed to conservation and sustainable tourism.',
      imageUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=500&q=80',
      specialties: ['Safari Tours', 'Wildlife Photography', 'Bird Watching'],
      languages: ['English', 'Swahili'],
    ),
  ];

  late final List<TourPackage> packages = [
    TourPackage(
      title: 'Ultimate Mountain Adventure',
      location: 'Rocky Mountains, Colorado',
      rating: 4.9,
      reviewCount: 23,
      days: 5,
      price: '899',
      imageUrl: 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?w=500&q=80',
      groupSize: '6-12',
      guides: [guides[0], guides[1]],
      highlights: ['Summit hiking', 'Wildlife spotting', 'Camping under stars'],
    ),
    TourPackage(
      title: 'San Francisco Cultural Immersion',
      location: 'San Francisco, California',
      rating: 4.7,
      reviewCount: 34,
      days: 3,
      ...
      groupSize: '8-15',
      guides: [guides[1]],
      highlights: ['Golden Gate Bridge', 'Chinatown exploration', 'Food truck tours'],
    ),
  ];
  // --- End Dummy Data ---
  ...
  Widget _buildPackagesList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return PackageCard(tourPackage: packages[index]);
      },
    );
  }
}*/
