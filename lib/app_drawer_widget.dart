...
import 'language_translator_screen.dart';
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              /*  _drawerItem(Iconsax.card, "Payment History", () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentHistoryScreen()));
                }),
                _drawerItem(Iconsax.calendar, "Calendar", () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const CalendarScreen()));
                }),
                _drawerItem(Iconsax.location, "Trip Tracker", () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const TripTrackerScreen()));
                }),*/
              ...
              Navigator.of(context).pushAndRemoveUntil(
                ...
                (Route<dynamic> route) => false,
                 ...
                 // Navigator.pop(context); // You can add logout logic here
                }, color: Colors.red),
              ],
            ),
          ),
