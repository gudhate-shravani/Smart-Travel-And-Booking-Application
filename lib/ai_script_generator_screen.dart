                  ...
                  Wrap(
                    ...
                    children: places.map((place) {
                      ...
                      return ChoiceChip(
                        ...
                        selected: isSelected,
                        onSelected: (val) {
                          setState(() => selectedPlace = val ? place : '');
                        },
                        backgroundColor: Colors.grey.shade100,
                        selectedColor: const Color(0xFF7F67F8).withOpacity(0.2),
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Iconsax.magicpen,
                      size: 36, color: Color(0xFF7F67F8)),
                ),
                const SizedBox(height: 12),
                const Text(
                ...
                const Text(
                  "Select a place and let AI craft an engaging,\ninformative script for your tours",
...
class _AIScriptGeneratorScreenState extends State<AIScriptGeneratorScreen> {
 ...
 static const String geminiEndpoint =
  ...
  // Languages offered (displayLabel -> locale code)
