...
class _AddVehicleFormState extends State<AddVehicleForm>
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Flexible(child: _getStepContent()), // FIXED: Use Flexible
    ...
    return Row(
      ...
      children: [
        if (_currentStep != 0)
          OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              overlayColor: Colors.transparent, // FIXED
            ),
        ...
        ElevatedButton(
          ...
          child: Text(_currentStep == 2 ? "Add Vehicle" : "Next"),
        ),
      ],
    );
  }
  ...
  void _nextStep() {
    if (_currentStep < 2) {
      ...
      // Do NOT auto-close the popup or bottom sheet here
    }
  }
            ...
            child: Center(
              child: Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    // Animated checkmark in a gradient circle
                    Container(
                      width: 90,
                      height: 90,
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [Colors.green.shade400, Colors.greenAccent.shade100],
                    ...
                    const Text(
                      "Vehicle Added!",
                      style: TextStyle(
                        fontFamily: 'Montserrat', // Professional font
                        fontSize: 24,
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: const [
                          Icon(Icons.directions_car, color: Colors.green, size: 22),
                          SizedBox(width: 8),
                          Flexible(
                            child: Text(
